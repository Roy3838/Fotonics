...
# Path to images
roy_path = "/home/jay/Fotonics/LaboratorioStokes/ImagesCut/"
IM_PATH = roy_path

# Load images
Ix = Float64.(Gray.(load(IM_PATH*"1_1.jpg")))
Iy = Float64.(Gray.(load(IM_PATH*"1_2.jpg")))
Id = Float64.(Gray.(load(IM_PATH*"1_3.jpg")))
Ia = Float64.(Gray.(load(IM_PATH*"1_4.jpg")))
Ir = Float64.(Gray.(load(IM_PATH*"1_5.jpg")))
Il = Float64.(Gray.(load(IM_PATH*"1_6.jpg")))
