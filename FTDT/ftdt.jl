...
function simular(medio, idx, idy)
  ...
  #   idy = 1:ie;
  #   medioProp = epsz;
  #   save(File(format"JLD",string(pwd(),"\\gifMagico\\casoMaterialLuneburg.jld")),"caso",casoMaterial)
  # elseif casoMaterial=="luneburg"
  #   # Lente de Luneburg
  #     f = 1;
  ...
  # elseif casoMaterial=="luneburgColumna"
